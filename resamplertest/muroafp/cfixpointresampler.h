...
public:
    CFixPointResampler(int16_t *m_outbuffer_i16,
    		           int out_buffer_size,
    ...
    int resampleFrame(int16_t *inbuffer_i16, int num_frames, int16_t* outbuffer, double factor = 1.0);
...
private:
  ...
  void addSamplesInX(int16_t* inbuffer, int num_frames);
  void resample(float factor);
  int copyResampledFramesToOutBuffer(int16_t* outbuffer);
