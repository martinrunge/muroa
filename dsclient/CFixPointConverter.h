...
#ifndef _CFIXPOINTCONVERTER_H_
#define _CFIXPOINTCONVERTER_H_
...
public:
   ...
   CFixPointConverter(bool  high_quality, bool  linear_interpolation, bool  filter_interpolation);
...
private:
   ...
   CFixPointConverter(const CFixPointConverter& op);

   const CFixPointConverter&
   operator=(const CFixPointConverter& op);

   int err_ret(char *s);

   void deleteMemory();

   int readData(int   inCount,       /* _total_ number of frames in input file */
   ...
   int resampleFast( int& inCount,     
                     int outCount,   
                     short inArray[], 
                     short outArray[]);
 
   int resampleWithFilter( int& inCount, 
                           int outCount,
                           short inArray[],
                           short outArray[],
                           short Imp[], 
