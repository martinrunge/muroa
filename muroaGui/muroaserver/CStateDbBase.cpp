...
void CStateDbBase::saveSession(CSession const * const session) {
...
void CStateDbBase::restoreSession(CSession * const session) {
...
void CStateDbBase::updateCollectionTable( CSession const * const session, int minrev, int maxrev ) {
...
void CStateDbBase::updateCollectionItem( CCollectionItem* item ) {
...
void CStateDbBase::updatePlaylistItem( int plPos, CPlaylistItem* item, int plRev, int colRev ) {
...
void CStateDbBase::updateNextlistItem( int nlPos, CPlaylistItem* item, int nlRev, int plRev ) {

}

CCollectionItem* CStateDbBase::getCollectionItemByHash(unsigned hash) {
	CCollectionItem* item;
...
CCollectionItem* CStateDbBase::getCollectionItemByPos(int colPos, int colRev) {
...
CCollectionItem* CStateDbBase::getCollectionItemFromStmt(sqlite3_stmt *pStmt) {
...
CPlaylistItem* CStateDbBase::getPlaylistItemFromStmt(sqlite3_stmt *pStmt) {
	unsigned hash = sqlite3_column_int(pStmt, 0);
	CPlaylistItem* item = new CPlaylistItem( hash );
	return item;
}

CPlaylistItem* CStateDbBase::getPlaylistItemByPos(int pos, int rev) {
...
CPlaylistItem* CStateDbBase::getNextlistItemByPos(int pos, int rev) {
...
void CStateDbBase::updatePlaylistRevsTable(CSession const * const session, int minrev, int maxrev ) {
...
int CStateDbBase::rowIDofPlRevEntry(int plPos, int colHash, int plRev, int colRev) {
...
void CStateDbBase::updateNextlistRevsTable(CSession const * const session, int minrev, int maxrev ) {

}

void CStateDbBase::restoreCollection(CSession * const session) {
...
void CStateDbBase::restorePlaylists(CSession * const session) {
...
void CStateDbBase::restoreNextlists(CSession * const session) {
...
void CStateDbBase::prepareUpdateColItemStmt() {
...
void CStateDbBase::finalizeUpdateColItemStmt() {
...
void CStateDbBase::prepareSelectColItemStmt() {
	prepareStmt(&m_selectColItemStmt, "SELECT * FROM collection WHERE hash=?");
}

void CStateDbBase::finalizeSelectColItemStmt() {
...
void CStateDbBase::prepareGetColItemByPosStmt() {
...
void CStateDbBase::finalizeGetColItemByPosStmt() {
	finalizeStmt( &m_getColItemByPosStmt );
}

void CStateDbBase::prepareUpdatePlaylistItemStmt() {
